...
app.controller('MainCtrl', ['$scope', '$timeout', '$modal', '$log', '$http', function($scope, $timeout, $modal, $log, $http) {
  ...
  $scope.datasets = [
    ...
    {name:'Total Net Enrollment Ratio in Primary Education', src:'/fulldatasets/2aa.json', color: 'green', dataType: '%', number: 2, target: "Ensure that, by 2015, children everywhere, boys and girls alike, will be able to complete a full course of primary schooling"},
    ...
    {name:'Share of Women in Wage Employment in the Non-Agricultural Sector', src:'/fulldatasets/3ad.json', color: 'green', dataType: '%', number: 3, target: "Eliminate gender disparity in primary and secondary education, preferably by 2005, and in all levels of education no later than 2015"},
